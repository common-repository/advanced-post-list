...
function apl_render_page_parents( $post_type, $apl_post_list, $page_parent = 0, $indent = 0 ) {
	...
	<?php if ( 0 === $page_parent ) : ?>
		...
		<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text_parent ); ?>"></span>
		<br />
		<br />
		<table class="widefat">
			<thead>
...
?>
<?php wp_nonce_field( 'apl_nonce', 'apl_nonce' ); ?>
<div class="apl-filter-box-1">
	<div class="apl-left-minibar">
		<h3>
			<?php esc_html_e( 'Post Types', 'advanced-post-list' ); ?>
			<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['post_types'] ); ?>"></span>
		</h3>
						...
						<?php if ( ! empty( $v_pt_arr['tax_arr'] ) ) : ?>
							<li class="apl-t-li-post-type">
								<a href="#apl-t-<?php echo esc_attr( $k_pt_slug ); ?>-type-taxonomies">
									<h5><?php esc_html_e( 'Taxonomies', 'advanced-post-list' ); ?><span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['taxonomy_tab'] ); ?>"></span></h5>
								</a>
							</li>
						<?php endif; ?>
							...
							<?php if ( $apl_post_type_objs[ $k_pt_slug ]->hierarchical ) : ?>
								<li class="apl-t-li-post-type">
									<a href="#apl-t-<?php echo esc_attr( $k_pt_slug ); ?>-type-pages">
										<h5><?php esc_html_e( 'Parent Pages', 'advanced-post-list' ); ?><span class="apl-help apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['parent_page_tab'] ); ?>"></span></h5>
									</a>
								</li>
							<?php endif; ?>
						<?php endif; ?>
					...
					<?php if ( ! empty( $v_pt_arr['tax_arr'] ) ) : ?>
						<div id="apl-t-<?php echo esc_attr( $k_pt_slug ); ?>-type-taxonomies">
							<div class="apl-pt-taxonomy-selector">
								...
								<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['taxonomy_multiselect'] ); ?>"></span>
							</div>
										...
										<div id="apl-t-div-<?php echo esc_attr( $k_pt_slug ); ?>-<?php echo esc_attr( $tax_slug ); ?>" class="apl-t-terms" style="<?php echo esc_attr( $tax_display ); ?>">
											...
											<ul>
												<li>
													...
													<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['require_terms'] ); ?>"></span>
												</li>
												<li>
													...
													<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['dynamic_terms'] ); ?>"></span>
												</li>
											</ul>
...
<div class="apl-filter-box-2">
	...
	<div class="apl-filter-box-2-left">
		...
		<div class="apl-filter-field-left-row apl-list-amount-row">
			<div>
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['list_amount'] ); ?>"></span>
			</div>
			<div>
		...
		<div class="apl-filter-field-left-row apl-list-offset-row">
			<div>
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['offset'] ); ?>"></span>
			</div>
			<div>
		...
		<div class="apl-filter-field-left-row apl-order-by">
			<div>
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['order_by'] ); ?>"></span>
			</div>
			<div>
		...
		<div class="apl-filter-field-left-row apl-authors">
			<div>
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['authors'] ); ?>"></span>
			</div>
			<div>
				<div>
					<!-- INPUT -->
		...
		<div class="apl-filter-field-left-row">
			<div>
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['post_status'] ); ?>"></span>
			</div>
			<div>
				<select id="apl_multiselect_post_status_1" class="apl-multiselect-post-status-1" name="apl_post_status_1[]" multiple="multiple" style="width:96px;">
					<option <?php echo esc_html( apl_selected_post_status( 'none', $apl_post_list->post_status ) ); ?> value="none"><?php esc_html_e( '- None -', 'advanced-post-list' ); ?></option>
					<option <?php echo esc_html( apl_selected_post_status( 'any', $apl_post_list->post_status ) ); ?> value="any"><?php esc_html_e( 'Any', 'advanced-post-list' ); ?></option>
					<option <?php echo esc_html( apl_selected_post_status( 'public', $apl_post_list->post_status ) ); ?> value="public"><?php esc_html_e( 'Public', 'advanced-post-list' ); ?></option>
					<option <?php echo esc_html( apl_selected_post_status( 'private', $apl_post_list->post_status ) ); ?> value="private"><?php esc_html_e( 'Private (BETA)', 'advanced-post-list' ); ?></option>
				</select>
				<select id="apl_multiselect_post_status_2" class="apl-multiselect-post-status-2" name="apl_post_status_2[]" multiple="multiple">
					<option <?php echo esc_html( apl_selected_post_status( 'publish', $apl_post_list->post_status ) ); ?> value="publish"><?php esc_html_e( 'Published', 'advanced-post-list' ); ?></option>
					<option <?php echo esc_html( apl_selected_post_status( 'pending', $apl_post_list->post_status ) ); ?> value="pending"><?php esc_html_e( 'Pending Review', 'advanced-post-list' ); ?></option>
					<option <?php echo esc_html( apl_selected_post_status( 'draft', $apl_post_list->post_status ) ); ?> value="draft"><?php esc_html_e( 'Draft', 'advanced-post-list' ); ?></option>
					<option <?php echo esc_html( apl_selected_post_status( 'auto-draft', $apl_post_list->post_status ) ); ?> value="auto-draft"><?php esc_html_e( 'Auto-Draft', 'advanced-post-list' ); ?></option>
					<option <?php echo esc_html( apl_selected_post_status( 'future', $apl_post_list->post_status ) ); ?> value="future"><?php esc_html_e( 'Scheduled', 'advanced-post-list' ); ?></option>
					<option <?php echo esc_html( apl_selected_post_status( 'inherit', $apl_post_list->post_status ) ); ?> value="inherit"><?php esc_html_e( 'Revisions', 'advanced-post-list' ); ?></option>
					<option <?php echo esc_html( apl_selected_post_status( 'trash', $apl_post_list->post_status ) ); ?> value="trash"><?php esc_html_e( 'Trash', 'advanced-post-list' ); ?></option>
				</select>
			</div>
		</div>
		<div class="apl-filter-field-left-row">
			<div>
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['user_perms'] ); ?>"></span>
			</div>
			<div>
	...
	<div class="apl-filter-box-2-right">
		...
		<div class="apl-filter-field-row-full">
			...
			<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['exclude_posts_by_id'] ); ?>"></span>
		</div>
		<div class="apl-filter-field-row-full">
			<input type="text" id="apl_exclude_posts" class="apl-text-exclude-posts" name="apl_post__not_in" value="<?php echo esc_attr( implode( ',', $apl_post_list->post__not_in ) ); ?>" />
		</div>
		<!-- STICKY POSTS -->
		<div class="apl-filter-field-right-row">
			...
			<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['enable_sticky_posts'] ); ?>"></span>
		...
		<div class="apl-filter-field-right-row">
			...
			<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['exclude_current_post'] ); ?>"></span>
		...
		<div class="apl-filter-field-right-row">
			...
			<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['exclude_duplicate_posts'] ); ?>"></span>

...
<form id="apl-settings-form" method="post" action="<?php echo esc_attr( admin_url( 'admin-post.php' ) ); ?>" >
	...
	<div class="apl-settings-row" >
		<div class="apl-row-first-cell">
			...
			<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['ignore_post_types'] ); ?>"></span>
		</div>
		<div>
			<?php foreach ( $tmp_post_types as $k1_slug => $v1_name ) : ?>
				<input type="checkbox" id="apl_ignore_pt_<?php echo esc_attr( $k1_slug ); ?>" class="apl-chk-ignore-pt" name="apl_ignore_pt_<?php echo esc_attr( $k1_slug ); ?>" value="<?php echo esc_attr( $k1_slug ); ?>" <?php echo ( in_array( $k1_slug, $options['ignore_post_types'] ) ) ? 'checked="checked"' : ''; ?> />
				<label for="apl_ignore_pt_<?php echo esc_attr( $k1_slug ); ?>"><?php echo esc_html( $v1_name ); ?></label>
				<br />
			<?php endforeach;?>
		</div>
	</div>
	<div class="apl-settings-row" >
		<div class="apl-row-first-cell">
			...
			<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['delete_on_deactivate'] ); ?>"></span>
		</div>
		<div>
	...
	<div class="apl-settings-row" style="margin-bottom: 3px;">
		<div class="apl-row-first-cell">
			...
			<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['default_empty_enable'] ); ?>"></span>
		</div>
		<div>

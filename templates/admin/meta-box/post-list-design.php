...
if ( 'apl_post_list' === $post->post_type ) {
	...
	wp_die( 'Objects aren\'t being loaded correctly in `' . esc_html( dirname( __FILE__ ) ) . esc_html( basename( __FILE__ ) ) . '`.' );
}
	...
	<div class="apl-design-column">
		<div class="apl-design-row">
			<div>
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['before_list'] ); ?>"></span>
			</div>
		...
		<div class="apl-design-row">
			<div>
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['list_content'] ); ?>"></span>
				<br />
		...
		<div class="apl-design-row">
			<div>
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['after_list'] ); ?>"></span>
			</div>
		...
		<div class="apl-design-row">
			<div>
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['empty_message'] ); ?>"></span>
			</div>
				...
				<div>
					<?php if ( 0 !== $apl_design->id ) : ?>
						<div style="margin: 1em 0;">
								<a class="button button-secondary button-edit-post-link" href="<?php echo esc_url_raw( get_edit_post_link( $apl_design->id ) ); ?>" target="_blank"><?php esc_html_e( 'Edit Translation(s) of this Design.', 'advanced-post-list' ) ?></a>
						</div>
					<?php else : ?>
						<p><?php esc_html_e( 'Please save the Post List in order to manage translations of this Design.', 'advanced-post-list' ); ?></p>
					<?php endif; ?>
				</div>
			</div>
		<?php endif; ?>

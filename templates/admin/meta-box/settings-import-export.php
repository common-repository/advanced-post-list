...
<div style="display: inline-block; width: 100%;">
	...
	<div class="apl-settings-row" >
		<div class="apl-row-first-cell">
			...
			<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['export_filename'] ); ?>"></span>
		</div>
		<div class="apl-cell-1of2" >
			<input type="text" id="apl_export_filename" style="width: 100%;" value="APL-<?php echo esc_attr( date( 'Y-m-d-Hi' ) ); ?>" />
	...
	<form id="form_settings_import" name="apl_form_import" method="post" enctype="multipart/form-data" action>
		<div class="apl-settings-row" >
			...
			<div class="apl-row-first-cell">
				...
				<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['import_file'] ); ?>"></span>
			</div>
			<div class="apl-cell-1of2" >
	...
	<div class="apl-settings-row" >
		<div class="apl-row-first-cell">
			...
			<span class="apl-tooltip apl-help apl-help-icon dashicons dashicons-editor-help" title="<?php echo esc_attr( $apl_help_text['restore_defaults'] ); ?>"></span>
		</div>
		<div class="apl-cell-1of2" >
			<p>
